...
{
    class UDPBroadcastConsoleApp
    {
        static IPAddress remoteAddress; // хост для отправки данных
        const int remotePort = 18123; // порт для отправки данных
        const int localPort = 18123; // локальный порт для прослушивания входящих подключений
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                remoteAddress = IPAddress.Parse("224.1.1.1");
